...
def insertData(subject, press, pDate, pTime, link, imgLinkUrl):
    # con : mysql과 파이썬 연결 도구
    # cur : cursor -> 디비 정보를 조작하기 위한 도구.
    con, cur = None, None
    data = ""
    data0, data1, data2, data3, data4, data5, data6 = "", "", "", "", "", "", ""
    sql = ""
    con = pymysql.connect(host='10.100.103.12', user='pgm',
                          password='1234', database='naverdb', charset='utf8')
    cur = con.cursor()
